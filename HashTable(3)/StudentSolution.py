...
'''test = PhoneBook()
test.read_records_from_file('Details.txt')
#print(test.fetch_contacts("Rahul Kumar Mishra"))
test.delete_contact("Rahul Kumar Mishra")
#print(test.fetch_contacts("Rahul Kumar Mishra"))
for i in test.fetch_contacts("Rahul Kumar Mishra"):
    print(i.get_name())
contacts = test.fetch_contacts("Rauhl Kumar Mishra")
#print(len(contacts))'''
